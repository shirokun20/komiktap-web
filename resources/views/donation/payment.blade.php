    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.getElementById('amountDisplay').textContent =
                new Intl.NumberFormat('id-ID', { style: 'currency', currency: 'IDR', maximumFractionDigits: 0 }).format(Math.round(Number(AMOUNT) || 0));
            setStep(1);
            fetchPaymentMethods();
        });
        ...
        // ====================================
        // Submit Donation (Fansku QRIS otomatis — no method selection)
        // ====================================
