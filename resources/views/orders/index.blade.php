    ...
    <main class="flex-grow py-12 px-4">
        <div class="max-w-2xl mx-auto">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-gray-400 text-sm mt-2">Otomatis menampilkan transaksi dengan email login <strong class="text-[#ff7900]">{{ auth()->user()->email }}</strong></p>
            </div>

            <!-- Info login -->
            <div class="glass-card rounded-2xl p-4 mb-6 flex items-center gap-3">
                <i class="fas fa-lock text-[#ff7900]"></i>
                <p class="text-gray-400 text-xs">Terkunci ke email login Google. Riwayat lama berbasis nomor WA tidak tampil di sini.</p>
            </div>
            ...
            @if(isset($searched))
                ...
                @else
                    <div class="glass-card rounded-2xl p-10 text-center">
                        ...
                        <h3 class="text-white font-semibold mb-2">Belum ada pesanan</h3>
                        <p class="text-gray-500 text-sm mb-6">Transaksi dengan email ini belum ditemukan. Mulai dari halaman utama untuk beli premium atau donasi.</p>
                        <a href="{{ url('/#pricing') }}"
